...
import { assertAccountLifecycleAllowed, loadOperationMode } from './operation-mode.mjs';
...
export function patchAccountLifecycle({ accountsConfig, policy = {}, accountId, target, history = [], metrics = [], operationMode = null }) {
  ...
  if (operationMode) assertAccountLifecycleAllowed(target, operationMode);
